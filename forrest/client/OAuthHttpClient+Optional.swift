//
//  OAuthHttpClient+Optional.swift
//  ForREST
//
...
extension OAuthHttpClient {
     ...
     */
    public func addRequestToQueue<T: OptionalResponseHandleableProtocol>(request: RequestPrototype<T>) {
     ...
     */
    private func attemptUserAccessRequest<T: OptionalResponseHandleableProtocol>(request: RequestPrototype<T>)
    {
     ...
     */
    private func attemptAnyAccessRequest<T: OptionalResponseHandleableProtocol>(request: RequestPrototype<T>)
    {
        if (oauthStateProvider.userAccessIntended()) {
            attemptUserAccessRequest(request: request)
            return
     ...
     */
    internal func makeRequest<T: OptionalResponseHandleableProtocol>(requestObject: RequestPrototype<T>)
    {
     ...
     */
    private func attemptUserAccessRefresh<T: OptionalResponseHandleableProtocol>(request: RequestPrototype<T>)
    {
     ...
     */
    private func attemptAppAccessRequest<T: OptionalResponseHandleableProtocol>(request: RequestPrototype<T>)
    {
     ...
     */
    private func attemptAppAuthentication<T: OptionalResponseHandleableProtocol>(request: RequestPrototype<T>)
    {
